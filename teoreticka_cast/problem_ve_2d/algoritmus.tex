...
Pokud tyto body tvoří trojúhelník, pak tvoří podgraf $T = (V_T, E_T, w)$, kde množina bodů $V_T = \{u, j, v\}$, množina hran $E_T = \{\{u,j\}, \{j,v\}, \{u,v\}\}$ a váha hran se zachová. Pokud tento podgraf bude mít celkovou váhu menší než ten, který jsme doposud našli, uložíme jej a vrátíme hranu $\{u, v\}$ do množiny hran $E$. Tento postup opakujeme dokud nevyzkoušíme všchny hrany. Výsledkem bude trojúhelník s minimálním obvodem. Na \myref{obrázku}{obr:algoritmus_graf} můžete vidět jak algoritmus funguje.
