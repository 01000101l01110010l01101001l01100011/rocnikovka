...
emphstyle={[1]\color{pwurple}},
emph = {[2]networkx, Graph, G, set, float, dijkstra, math},
emphstyle={[2]\color{gween}},
emph = {[3]def, lambda, Q, None},
emphstyle={[3]\color{bwlue}},
emph = {[4]dijkstra_triangle, add, remove, get_edge_data, (,), [,], in, min, remove_edge, add_edge, list, sort, range, add_weighted_edges_from, dist, find_path, algorithm, abs, len, pop, append},
emphstyle={[4]\color{yeluwu}},
