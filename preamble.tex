...
emphstyle={[3]\color{bwlue}},
emph = {[4]dijkstra_triangle, add, remove, get_edge_data, (,), [,], in, min, remove_edge, add_edge, list, sort, range, add_weighted_edges_from, dist, find_path, algorithm, abs, len, pop, append, neighbors, vstack, det, euclidean},
emphstyle={[4]\color{yeluwu}},
