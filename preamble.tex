...
\usepackage{tikz}
\usetikzlibrary{%
 positioning, graphs, graphs.standard, shapes.geometric,quotes, calc, perspective, shapes
}
\usepackage{mdframed}
...
emph = {[1]for, while, if, return, from, import},
emphstyle={[1]\color{pwurple}},
emph = {[2]networkx, Graph, G, set, float, dijkstra},
emphstyle={[2]\color{gween}},
emph = {[3]def, lambda, Q},
emphstyle={[3]\color{bwlue}},
emph = {[4]dijkstra_triangle, add, remove, get_edge_data, (,), [,], in, min, remove_edge, add_edge},
emphstyle={[4]\color{yeluwu}},
