...
Naprogramovat \myref{algoritmus}{alg:algoritmus_1D}, který řeší problém v dimenzi 1, je velmi jednoduchý. Využijeme funkci sort() z knihovny NumPy, která dokáže seřadit prvky v seznamu. Vstupem bude množina bodů a výstupem budou 2 body, které tvoří nejkratší úsečku
